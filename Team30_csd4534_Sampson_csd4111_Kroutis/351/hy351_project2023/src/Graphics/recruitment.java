...
public class recruitment extends JFrame {
	...
	//	setVisible(true);
		...
		//contentPane.ImageIcon(this.getClass().getResource("/Mainframe.png")).getImage(), 0, 0, getWidth(), getHeight(), this);};
	...
	//sunartisi gia upologismo kai arxikopoiisi misthou kai epidomatos
